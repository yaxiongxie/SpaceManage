...
public class CommonDataDecoratedegree {
    ...
    private int sortInt;
    private Collection<PublishOfficelist> publishOfficelistsById;
    ...
    @OneToMany(mappedBy = "commonDataDecoratedegreeByDecorateId")
    public Collection<PublishOfficelist> getPublishOfficelistsById() {
        return publishOfficelistsById;
    }

    public void setPublishOfficelistsById(Collection<PublishOfficelist> publishOfficelistsById) {
        this.publishOfficelistsById = publishOfficelistsById;
    }
}
