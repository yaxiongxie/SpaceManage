...
var myApp=angular.module('myApp',['ngLoadScript','ng-fusioncharts','ngSanitize','ui.router','angular-loading-bar', 'ngAnimate','oc.lazyLoad','ui.bootstrap','angularBootstrapNavTree','toaster','ng-bootstrap-datepicker','elif','ngMaterial'],function($httpProvider) {
